      ...
      <table className="min-w-full text-left text-sm text-slate-700">
        <thead className="text-black bg-slate-200">
          <tr>
            ...
            <th className="px-4 py-3 font-medium text-right"><Sorter sortString='total_due'>Total Due</Sorter></th>
            <th className="px-4 py-3 font-medium text-right"><Sorter sortString='total_due'>Next Payment Date</Sorter></th>
            <th className="px-4 py-3 font-medium text-right"><Sorter sortString='total_due'>Next Payment</Sorter></th>
            <th className="px-4 py-3 font-medium text-right"><Sorter sortString='total_due'>Regular Payment</Sorter></th>
